...
# Position for the middle third
middle_x=$((screen_x + third_width))

# Resize and move the window to the middle third
wmctrl -i -r $WINDOW -e 0,$middle_x,$screen_y,$third_width,$adjusted_height